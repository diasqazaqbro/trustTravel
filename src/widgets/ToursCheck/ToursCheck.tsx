...
import { IPlace, ITour } from "@/app/attractions/[id]/page";
...
const ToursCheck = ({ info, tours }: Props) => {
    ...
    <>
        ...
        <div className="container">
          <div className={styles.tour__title}>
            <div className={styles.tour__desc}>
              <h1>{info[0] ? info[0].name : "loading"}</h1>
              <p>{info[0] ? info[0].description : "loading"}</p>
            </div>
            {/* Grid */}
            <div className={styles.tour__buy}>
              <img src={info[0] ? info[0].image : ""} alt={"Tour"} />
              <div className={styles.tour__cost}>
                <h5>Цена: </h5>
                <h1>{info[0] ? info[0].price : ""} ₸</h1>
              </div>
              <div className={styles.tour__buy_btn}>
                <Button
                  className={styles.tour__buying}
                  text="Купить"
                  disabled={false}
                />
                <Button
                  className={styles.tour__basket}
                  text="Корзина"
                  disabled={false}
                />
              </div>
        ...
        <div className="container">
          <div className={styles.tour__info_help}>
            <div className={styles.tour__help_left}>
              ...
              <p>
                Попасть на территорию можно на личном автомобиле (лучше хороший
                подготовленный внедорожник) либо с тур-операторами. Расстояние
                60 км от Шымкента. В 28 км от поселка Жабаглы Тюлькубасского
                района Туркестанской области. Спуск и подъем в каньон Аксу (300
                метров) - пеший.
              </p>
              <h4>
                <span>Время посещения: </span> зависит от погодных условий и
                места назначения.
              </h4>
              <h4>
                <span>Режим работы: </span> круглогодично (лучшее время года для
                посещения - лето и осень).
              </h4>
              <h4>
                <span>Адрес: </span> Туркестанская область, Тюлькубаский район.
              </h4>
            </div>
            {/* Grid */}
      ...
      <section className={styles.related__items}>
        <div className="container">
          ...
          {tours ? tours.map((item, index) => <RelatedItems key={index} tours={item}/>) : ''}
        </div>
      </section>
        ...
        <section className={styles.mobile__tour_header}>
          ...
          <div className="container">
            <div className={styles.mobile__tour_title}>
              ...
              <p>
                Туры от TrusTTravel — это возможность погрузиться в мир
                величественных пейзажей, где каждый шаг открывает новые грани
                красоты и приключений.
              </p>
            </div>
            <div className={styles.mobile__tour_more}>
              <h4>
                <span>Организатор: </span> TrusTTravel
              </h4>
              <h4>
                <span>Трансфер: </span> В две стороны
              </h4>
              <h4>
                <span>Питиание: </span> Еда (1 раз), горячий чай
              </h4>
              <h4>
                <span>Другое: </span> фотоссесия и съёмка
              </h4>
              <h4>
                <span>Дата: </span> 6 января
              </h4>
            </div>
          ...
          <section className={styles.mobile__tour_info}>
            <div className={styles.container__info}>
              <div className={styles.mobile__info_title}>
                <h1>Как добраться самому ?</h1>
                <p>
                  Попасть на территорию можно на личном автомобиле (лучше
                  хороший подготовленный внедорожник) либо с тур-операторами.
                  Расстояние 60 км от Шымкента. В 28 км от поселка Жабаглы
                  Тюлькубасского района Туркестанской области. Спуск и подъем в
                  каньон Аксу (300 метров) - пеший.
                </p>
                <h4>
                  <span>Время посещения: </span> зависит от погодных условий и
                  места назначения.
                ...
                <h4>
                  <span>Режим работы: </span> круглогодично (лучшее время года
                  для посещения - лето и осень).
                </h4>
                <h4>
                  <span>Адрес: </span> Туркестанская область, Тюлькубаский
                  район.
                </h4>
              </div>
